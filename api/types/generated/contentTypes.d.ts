...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    types: Attribute.Enumeration<['porcelain', 'earthenware ', 'stoneware']> &
      Attribute.DefaultTo<'porcelain'>;
